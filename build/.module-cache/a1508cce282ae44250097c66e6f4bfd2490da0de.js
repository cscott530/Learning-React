...
var UserRecord = React.createClass({displayName: "UserRecord",
	render: function() {
		var userProgressCharts = this.props.progress.map(function(c) {
			return (React.createElement(UserProgressChart, {progress: c, user: this.props.user}))
		});
		return (
...
var UserProgressChart = React.createClass({displayName: "UserProgressChart",
	render: function() {
		return (
			React.createElement("div", {className: "userProgressChart"}
